<template>
	<div>
		...
		<el-drawer custom-class="drawer" :append-to-body="appendtobody" :modal="modal" 
		:close-on-click-modal="closeonclickmodal" title="图片中心" :visible.sync="drawer"
		 :direction="direction" :before-close="handleClose">
			...
			<el-dialog top="0" :visible.sync="dialogVisible" :close-on-click-modal="closeonclickmodal" custom-class="imgshow" :modal="modal" >
